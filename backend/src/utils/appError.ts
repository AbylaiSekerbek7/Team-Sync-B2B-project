...
export class AppError extends Error {
    ...
    public errorCode?: ErrorCodeEnumType; // Optional parameter, it can be passed or not.
...
export class BadRequestException extends AppError {
    constructor( 
        ...
        // errorCode || ErrorCodeEnum.VALIDATION_ERROR if errorCode defined use it, other ways use default errorCode.
    }
}
